...
class assemble_data_mnist_fashion:
    ...
    def create_training_data(self, n_e, corr_list, p_label_list):
        ...
        data_tuple_list = []
        for l in range(n_e):
            data_tuple_list.append(self.create_environment(l, x_train_fashion_mnist[ind_list[l], :, :, :],
                                                           y_train_fashion_mnist[ind_list[l], :], corr_list[l],
                                                           p_label_list[l]))
    ...
    def create_testing_data(self, corr_test, prob_label, n_e):
        ...
        (x_test, y_test, e_test) = self.create_environment(n_e, x_test_fashion_mnist, y_test_fashion_mnist, corr_test,
                                                           prob_label)
